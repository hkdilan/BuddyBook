...
import com.hkdilan.android.buddybook.utils.Lists;
import com.hkdilan.android.buddybook.utils.Maps;
...
public class SelectionBuilder {
    ...
    public Cursor query(SQLiteDatabase db, String[] columns, String groupBy,
        ...
        Log.d(TAG, "selection : "+selection+ "Selection Arg : "+Arrays.toString(selectionArgs));

        Cursor cursor=db.query(mTable, columns, selection, getSelectionArgs(), groupBy, having,
                orderBy, limit);
